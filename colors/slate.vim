...
ctermbg=lightgray
hi ErrorMsg		guifg=#F8F8F8	guibg=#D22613	gui=bold	ctermfg=lightgray
ctermbg=darkred	cterm=bold
hi WarningMsg	guifg=#F4EF82	guibg=#0F2130	gui=bold	ctermfg=yellow
ctermbg=black   cterm=bold

hi ModeMsg		guifg=#B0B3B9	guibg=#0F2130	gui=bold	ctermfg=lightgray
ctermbg=black	cterm=bold

if version >= 700 " Vim 7 specific colors
  hi CursorLine					guibg=#0F2130										ctermbg=black
cterm=NONE
  hi! link CursorColumn CursorLine
  hi MatchParen	guifg=#0F2130	guibg=#B0B3B9					ctermfg=black
ctermbg=lightgray
  hi Search		guifg=NONE		guibg=NONE		gui=inverse		ctermfg=NONE
ctermbg=NONE	cterm=inverse
endif

hi Pmenu		guifg=#000000	guibg=#F8F8F8					ctermfg=black
ctermbg=lightgray
hi PmenuSbar	guifg=#8A95A7	guibg=#F8F8F8	gui=NONE		ctermfg=darkcyan
ctermbg=lightgray	cterm=NONE
hi PmenuThumb	guifg=#F8F8F8	guibg=#8A95A7	gui=NONE		ctermfg=lightgray
...
hi Identifier	guifg=#f1994a									ctermfg=magenta
cterm=NONE
